            ...
            <ul className="flex items-center space-x-3 mt-9">
              <li>
                <a
                  href="/"
                  title=""
                  className="flex items-center justify-center text-white transition-all duration-200 bg-gray-800 rounded-full w-7 h-7 hover:bg-orange-400 focus:bg-amber-600"
                >
                  <svg
                    className="w-4 h-4"
